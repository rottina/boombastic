  ...
  getInternalChart: function(url) {
    ...
    case 'custom-playlist-prince':
      ...
      case 'custom-bilboard-2019':
        theData = [{ 'song': 'Without Me', 'artist': 'Halsey' }, { 'song': 'Sunflower', 'artist': 'Post Malone' }, { 'song': '7 Rings', 'artist': 'Ariana Grande' }, { 'song': 'Shallow', 'artist': 'Lady Gaga' }, { 'song': 'Sucker', 'artist': 'Jonas Brothers' }, { 'song': 'Old Town Road', 'artist': 'Lil Nas X' }];
        break;
      default:
