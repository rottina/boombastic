  ...
  getInternalChart: function(url) {
    ...
    case 'custom-playlist-prince':
      ...
      case 'custom-bilboard-2022':
          theData = [{ 'song': 'Easy on Me', 'artist': 'Adele' }, { 'song': 'All I want for christmas', 'artist': 'Mariah' }, { 'song': 'We Don\'t Talk About Bruno', 'artist': 'Carolina Gaitán' }, { 'song': 'Heat Waves', 'artist': 'Glass animals' }, { 'song': 'As It Was"', 'artist': 'Harry styles' }, { 'song': 'Jimmy Cooks', 'artist': 'Drake' }, { 'song': 'About Damn Time"', 'artist': 'Lizzo' }, { 'song': 'Wait for U', 'artist': 'Future' }];
          break;
      default:
