  ...
  getInternalChart: function(url) {
    ...
    case 'custom-playlist-prince':
      ...
      case 'custom-bilboard-2019':
        theData = [{ 'song': 'Thank U, Next', 'artist': 'Ariana Grande' }, { 'song': 'Without Me', 'artist': 'Halsey' }, { 'song': 'God Plan', 'artist': 'Post Malone' }, { 'song': 'Sunflower', 'artist': 'Drake' }, { 'song': '7 Rings', 'artist': 'Ariana Grande' }, { 'song': 'Shallow', 'artist': 'Lady Gaga' }, { 'song': 'Sucker', 'artist': 'Jonas Brothers'}];
        break;
      default:
