  ...
  getInternalChart: function(url) {
    ...
    case 'custom-playlist-prince':
      ...
      case 'custom-bilboard-2018':
        theData = [{ 'song': 'Perfect', 'artist': 'Ed Sheeran' }, { 'song': 'Havana', 'artist': '	Camila Cabello' }, { 'song': 'God Plan', 'artist': 'Drake' }, { 'song': 'Nice for What', 'artist': 'Drake' }, { 'song': 'This is America', 'artist': 'Childish Gambino' }, { 'song': 'Psycho', 'artist': 'Post Malone' }, { 'song': 'Sad!', 'artist': 'XXXTentacion' }, { 'song': 'I Like It', 'artist': 'Cardi B' }, { 'song': 'In My Feelings', 'artist': 'Drake' } ];
        break;
      default:
