  ...
  getInternalChart: function(url) {
    ...
    case 'custom-playlist-prince':
      ...
      case 'custom-bilboard-2023':
        theData = [{ 'song': 'Anti-Hero', 'artist': 'Taylor Swift' }, { 'song': 'All I Want for Christmas Is You', 'artist': 'Mariah' }, { 'song': 'Flowers', 'artist': 'Miley Cyrus' }, { 'song': 'Die for You', 'artist': 'Ariana Grande' }, { 'song': 'Last Night', 'artist': 'Morgan Wallen' }, { 'song': 'Kill Bill', 'artist': 'SZA' }, { 'song': 'Like Crazy', 'artist': 'Jimin' }];
        break;
      default:
