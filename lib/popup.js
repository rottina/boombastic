  ...
  getInternalChart: function(url) {
    ...
    switch(url) {
      ...
      case 'custom-bilboard-2016':
        theData = [ {'song':'Hello','artist':'Adele'}, {'song':'Sorry','artist':'Justin Bieber'}, {'song':'Love Yourself','artist':'Justin Bieber'}, {'song':'Pillowtalk','artist':'Zayn'}, {'song':'Work','artist':'Rhianna'} ];
        break;
