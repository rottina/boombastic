...
var Boom = {
  init: ()=> {
    ...
    if ((lastListenedTo === null) || (lastListenedTo.toLowerCase() === '')) {
        $('select option[value="https://pitchfork.com/rss/reviews/best/tracks/"]').attr('selected', 'selected');
        Boom.getXmlChart('https://pitchfork.com/rss/reviews/best/tracks/', 'item');
    } else {
  ...
  getInternalChart: function(url) {
    ...
    case 'custom-playlist-prince':
      ...
      case 'custom-bilboard-1964':
        theData = [ {'artist':'Lorne Green','song':'Ringo'}, {'artist':'Beatles','song':'I Feel Fine'}, {'artist':'Supremes','song':'Come See About Me'}, {'artist':'Bobby Vinton','song':'Mr. Lonely'}, {'artist':'Shangri-Las','song':'Leader of the Pack'}, {'artist':'Supremes','song':'Baby Love'}, {'artist':'Manfred Mann','song':'Do Wah Diddy Diddy'}, {'artist':'Orbison','song':'Pretty Woman'}, {'artist':'The Animals','song':'The House of the Rising Sun'}, {'artist':'Supremes','song':'Where Did Our Love Go'}, {'artist':'Dean Martin','song':'everybody loves somebody'}, {'artist':'The Beatles','song':'hard days night'}, {'artist':'The Beatles','song':'I Feel Fine'}, {'artist':'The Beatles','song':'Want to Hold Your Hand'}, {'artist':'The Beatles','song':'She Loves You'}, {'artist':'The Beatles','song':'Can\'t Buy Me Love'}, {'artist':'Bobby Vinton','song':'There! I\'ve Said It Again'}, {'artist':'Louis Armstrong','song':'Hello, Dolly!'}, {'artist':'Mary Wells','song':'My Guy'}, {'artist':'The Beatles','song':'Love Me Do'}, {'artist':'Dixie Cups','song':'Chapel of Love'}, {'artist':'Peter and Gordon','song':'World Without Love'}, {'artist':' Beach Boys','song':'I Get Around'}, {'artist':'Four Seasons','song':'Rag Doll'} ];
      break;
      case 'custom-bilboard-1965':
        theData = [{ 'artist': 'Petula Clark', 'song': 'Downtown' }, { 'artist': 'The Righteous Brothers', 'song': 'Loving Feeling' }, { 'artist': 'Gary Lewis %26 the Playboys', 'song': 'This Diamond Ring' }, { 'artist': 'The Temptations', 'song': 'My Girl' }, { 'artist': 'Beatles', 'song': 'Eight Days a Week' }, { 'artist': 'Supremes', 'song': 'Stop! In the Name of Love' }, { 'artist': 'Freddie and the Dreamers', 'song': 'Telling You Now' }, { 'artist': 'Wayne Fontana %26 The Mindbenders', 'song': 'Game of Love' }, { 'artist': 'Herman\'s Hermits', 'song': 'Mrs. Brown, You\'ve Got a Lovely Daughter' }, { 'artist': 'Beatles', 'song': 'Ticket to Ride' }, { 'artist': 'Beach Boys', 'song': 'Help Me Rhonda' }, { 'artist': 'Supremes', 'song': 'Back in My Arms Again' }, { 'artist': 'Four Tops', 'song': 'I Can\'t Help Myself' }, { 'artist': 'Byrds', 'song': 'Mr. Tambourine Man' }, { 'artist': 'Rolling Stones', 'song': 'Satisfaction' }, {
          'artist': 'Herman\'s Hermots', 'song': 'Henry VIII, I Am'
        }, { 'artist': 'Cher', 'song': 'I Got You Babe' }, { 'artist': 'Beatles', 'song': 'Help' }, { 'artist': 'Barry McGuire', 'song': 'Eve Of Destruction' }, { 'artist': 'McCoys', 'song': 'Hang On Sloopy' }, { 'artist': 'Beatles', 'song': 'Yesterday' }, { 'artist': 'Rolling Stones', 'song': 'Get Off of My Cloud' }, { 'artist': 'Supremes', 'song': 'I Hear a Symphony' }, { 'artist': 'Byrds', 'song': 'Turn! Turn! Turn!' }, { 'artist': 'Dave Clark Five', 'song': 'Over and Over' }];
        break;
      case 'custom-bilboard-1966':
        theData = [ {'artist':'Simon %26 Garfunkel','song':'The Sound of Silence'}, {'artist':'The Beatles','song':'We Can Work It Out'}, {'artist':'Petula Clark','song':'My Love'}, {'artist':'Lou Christie','song':'Lightnin\' Strikes'}, {'artist':'Nancy Sinatra','song':'These Boots Are Made for Walkin\''}, {'artist':'SSgt Barry Sadler','song':'Ballad of the Green Berets'}, {'artist':'The Righteous Brothers','song':'Soul and Inspiration'}, {'artist':'Young Rascals','song':'Good Lovin\''}, {'artist':'The Mamas %26 the Papas','song':'Monday, Monday'}, {'artist':'Percy Sledge','song':'When a Man Loves a Woman'}, {'artist':'The Rolling Stones','song':'Paint it Black'}, {'artist':'The Beatles','song':'Paperback Writer'}, {'artist':'Frank Sinatra','song':'Strangers in the Night'}, {'artist':'Tommy James and the Shondells','song':'Hanky Panky'}, {'artist':'The Troggs','song':'Wild Thing'}, {'artist':'The Lovin\' Spoonful','song':'Summer in the City'}, {'artist':'Donovan','song':'Sunshine Superman'}, {'artist':'The Supremes','song':'You Can\'t Hurry Love'}, {'artist':'The Association','song':'Cherish'}, {'artist':'The Four Tops','song':'Reach Out I\'ll Be There'}, {'artist':'? and the Mysterians','song':'96 Tears'}, {'artist':'The Monkees','song':'Last Train to Clarksville'}, {'artist':'Johnny Rivers','song':'Poor Side of Town'}, {'artist':'The Supremes','song':'You Keep Me Hangin\' On'}, {'artist':'The New Vaudeville Band','song':'Winchester Cathedral'}, {'artist':'The Beach Boys','song':'Good Vibrations'},{'artist':'The Monkees','song':'I\'m a Believer'} ];
      break;
      case 'custom-bilboard-1967':
        theData = [ {'artist':'The Monkees','song':'I\'m a Believer'}, {'artist':'The Buckinghams','song':'Kind of a Drag'}, {'artist':'The Rolling Stones','song':'Ruby Tuesday'}, {'artist':'The Supremes','song':'Love Is Here and Now You\'re Gone'}, {'artist':'The Beatles','song':'Penny Lane'}, {'artist':'The Turtles','song':'Happy Together'}, {'artist':'Archie Bell %26 the Drells','song':'Tighten Up'}, {'artist':'Sinatra','song':'Somethin\' Stupid'}, {'artist':'The Supremes','song':'The Happening'}, {'artist':'The Young Rascals','song':'Groovin\''}, {'artist':'Aretha Franklin','song':'Respect'}, {'artist':'The Association','song':'Windy'}, {'artist':'The Doors','song':'Light My Fire'}, {'artist':'The Beatles','song':'All You Need is Love'}, {'artist':'Bobbie Gentry','song':'Ode to Billie Joe'}, {'artist':'Box Tops','song':'The Letter'}, {'artist':'LuLu','song':'To Sir With Love'}, {'artist':'Strawberry Alarm Clock','song':'Incense and Peppermints'}, {'artist':'The Monkees','song':'Daydream Believer'}, {'artist':'The Beatles','song':'Hello, Goodbye'} ];
      break;
      ...
      case 'custom-bilboard-2016':
        theData = [ {'song':'Hello','artist':'Adele'},{'song':'Sorry','artist':'Justin Bieber'},{'song':'Love Yourself','artist':'Justin Bieber'},{'song':'Work','artist':'Rihanna'},{'song':'Panda','artist':'Desiigner'}, {'song':'One Dance','artist':' Drake '},{'song':'Can\'t Stop the Feeling!','artist':'Justin Timberlake'},{'song':'One Dance','artist':'Drake'},{'song':'Cheap Thrills','artist':'Sia'},{'song':'Closer','artist':'The Chainsmokers'},{'song':'Black Beatles','artist':'Rae Sremmurd'} ];
        break;
      case 'custom-bilboard-2017':
        theData = [ {'song':'Starboy','artist':'The Weeknd'}, {'song':'Black Beatles','artist':'Rae Sremmurd'}, {'song':'Bad and Boujee','artist':'Migos'}, {'song':'Shape of You','artist':'Ed Sheeran'}, {'song':'Perfect','artist':'Ed Sheeran'}, {'song':'Rockstar','artist':'Post Malone'}, {'song':'Despacito','artist':'Luis Fonsi'}, {'song':'I\'m the One','artist':'DJ Khaled'}, {'song':'That\'s What I Like','artist':'Bruno Mars'}, {'song':'Bad and Boujee','artist':'Migos'}, {'song':'Look What You Made Me Do','artist':'Taylor Swift'}, {'song':'Bodak Yellow','artist':'Cardi B'}];
        break;
      case 'custom-bilboard-2018':
        theData = [{ 'song': 'Perfect', 'artist': 'Ed Sheeran' }, { 'song': 'Havana', 'artist': '	Camila Cabello' }, { 'song': 'God Plan', 'artist': 'Drake' }, { 'song': 'Nice for What', 'artist': 'Drake' }, { 'song': 'This is America', 'artist': 'Childish Gambino' }, { 'song': 'Psycho', 'artist': 'Post Malone' }, { 'song': 'Sad!', 'artist': 'XXXTentacion' }, { 'song': 'I Like It', 'artist': 'Cardi B' }, { 'song': 'In My Feelings', 'artist': 'Drake' }, { 'song': 'Girls like you', 'artist': 'Maroon 5' }, { 'song': 'Thank U, Next', 'artist': 'Ariana Grande' }, { 'song': 'Sicko Mode', 'artist': 'Travis Scott' } ];
        break;
      case 'custom-bilboard-2019':
        theData = [{ 'song': 'Without Me', 'artist': 'Halsey' }, { 'song': 'Sunflower', 'artist': 'Post Malone' }, { 'song': '7 Rings', 'artist': 'Ariana Grande' }, { 'song': 'Shallow', 'artist': 'Lady Gaga' }, { 'song': 'Sucker', 'artist': 'Jonas Brothers' }, { 'song': 'Old Town Road', 'artist': 'Lil Nas X' }, { 'song': 'Bad Guy', 'artist': 'Billie Elish' }, { 'song': 'Senorita', 'artist': 'Shawn Mendes' }, { 'song': 'Truth Hurts', 'artist': 'Lizzo' }, { 'song': 'Highest in the room', 'artist': 'Travis Scott' }, { 'song': 'Someone You Loved', 'artist': 'Lewis Capaldi' }, { 'song': 'Lose You to Love Me', 'artist': 'Selena Gomez' }];
        break;
      case 'custom-bilboard-2020':
          theData = [{ 'song': 'The Box', 'artist': 'Roddy Ricch' }, { 'song': 'The Weekend', 'artist': 'Blinding Lights' }, { 'song': '7 Rings', 'artist': 'Drake' }, { 'song': 'Toosie Slide', 'artist': 'The Scotts' }, { 'song': 'The Scotts', 'artist': 'Jonas Brothers' }, { 'song': 'Say So', 'artist': 'Doja Cat' }, { 'song': 'Stuck with U', 'artist': 'Ariana Grande' }, { 'song': 'Savage', 'artist': 'Megan Thee Stallion' }, { 'song': 'Rain on Me', 'artist': 'Lady Gaga' }, { 'song': 'Rockstar', 'artist': 'DaBaby' }, { 'song': 'Trollz', 'artist': '6ix9ine' }, { 'song': 'Cardigan', 'artist': 'Taylor Swift' }, { 'song': 'Watermelon Sugar', 'artist': 'Harry Styles' }, { 'song': 'WAP', 'artist': 'Cardi B' }, { 'song': 'Dynamite', 'artist': 'BTS' }, { 'song': 'Franchise', 'artist': 'Travis Scott' }, { 'song': 'Savage Love', 'artist': 'Jawsh 685' }, { 'song': 'Mood', 'artist': '24kGoldn' }, { 'song': 'Positions', 'artist': 'Ariana Grande' }];
          break;
      case 'custom-bilboard-2021':
        theData = [{ 'song': 'Levitating', 'artist': 'Dua Lipa' }, { 'song': 'Save Your Tears', 'artist': 'The Weeknd' }, { 'song': 'Blinding Lights', 'artist': 'The Weeknd' }, { 'song': 'Mood', 'artist': '24kGoldn' }, { 'song': 'Good 4 U"', 'artist': 'Olivia Rodrigo' }, { 'song': 'Kiss Me More', 'artist': 'Doja Cat' }, { 'song': 'Leave the Door Open', 'artist': 'Silk Sonic' }, { 'song': 'Drivers License', 'artist': 'Olivia Rodrigo' }, { 'song': 'Montero', 'artist': 'Lil Nas X' }, { 'song': 'Peaches', 'artist': 'Justin Bieber' }, { 'song': 'Butter', 'artist': 'BTS' }, { 'song': 'Stay', 'artist': 'Kid Laroi' }, { 'song': '"Deja Vu', 'artist': 'Olivia Rodrigo' }, { 'song': 'Positions', 'artist': 'Ariana Grande' }, { 'song': 'Bad Habits', 'artist': 'Ed Sheeran' }, { 'song': 'Heat Waves', 'artist': 'Glass Animals' }, { 'song': 'Without You"', 'artist': 'Kid laroi' }, { 'song': 'Forever After All', 'artist': 'Luke Combs' }, { 'song': 'Go crazy', 'artist': 'Chris Brown' }, { 'song': 'Astromaut in the Ocean', 'artist': 'Masked wolf' }, { 'song': 'Easy on Me', 'artist': 'Adele' }];
        break;
      case 'custom-bilboard-2022':
          theData = [{ 'song': 'Anti-Hero', 'artist': 'Taylor Swift' }, { 'song': 'Unholy', 'artist': 'Sam Smith' }, { 'song': 'Bad Habit', 'artist': 'Steve Lacy' }, { 'song': 'Super Freaky Girl', 'artist': 'Nicki Minaj' }, { 'song': 'Break my soul', 'artist': 'Beyoncé' }, { 'song': 'Easy on Me', 'artist': 'Adele' }, { 'song': 'All I want for christmas', 'artist': 'Mariah' }, { 'song': 'We Don\'t Talk About Bruno', 'artist': 'Carolina Gaitán' }, { 'song': 'Heat Waves', 'artist': 'Glass animals' }, { 'song': 'As It Was"', 'artist': 'Harry styles' }, { 'song': 'Jimmy Cooks', 'artist': 'Drake' }, { 'song': 'About Damn Time"', 'artist': 'Lizzo' }, { 'song': 'Wait for U', 'artist': 'Future' }, { 'song': 'First Class', 'artist': 'Jack Harlow' }];
          break;
      case 'custom-bilboard-2023':
        theData = [{ 'song': 'Anti-Hero', 'artist': 'Taylor Swift' }, { 'song': 'All I Want for Christmas Is You', 'artist': 'Mariah' }, { 'song': 'Flowers', 'artist': 'Miley Cyrus' }, { 'song': 'Die for You', 'artist': 'Ariana Grande' }, { 'song': 'Last Night', 'artist': 'Morgan Wallen' }, { 'song': 'Kill Bill', 'artist': 'SZA' }, { 'song': 'Like Crazy', 'artist': 'Jimin' }, { 'song': 'Vampire', 'artist': 'Olivia Rodrigo' }, { 'song': 'Seven', 'artist': 'Jungkook' }, { 'song': 'Try That in a Small Town', 'artist': 'Jason Aldean' }, { 'song': 'Rich Men North of Richmond', 'artist': 'Oliver Anthony Music' }, { 'song': 'Slime You out', 'artist': 'Drake' }, { 'song': 'I remember everthing', 'artist': 'Zach Bryan' }];
        break;
      default:
